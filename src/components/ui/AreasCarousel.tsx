...
// Mapeamento de ícones SVG por nome
const icons: Record<string, JSX.Element> = {
  calculator: (
    <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="12" y="8" width="40" height="48" rx="4" stroke="#C9983A" strokeWidth="2"/>
      <rect x="18" y="14" width="28" height="10" rx="2" fill="#C9983A" fillOpacity="0.3"/>
      <rect x="18" y="30" width="8" height="8" rx="1" fill="#C9983A" fillOpacity="0.5"/>
      <rect x="28" y="30" width="8" height="8" rx="1" fill="#C9983A" fillOpacity="0.5"/>
      <rect x="38" y="30" width="8" height="8" rx="1" fill="#C9983A" fillOpacity="0.5"/>
      <rect x="18" y="42" width="8" height="8" rx="1" fill="#C9983A" fillOpacity="0.5"/>
      <rect x="28" y="42" width="8" height="8" rx="1" fill="#C9983A" fillOpacity="0.5"/>
      <rect x="38" y="42" width="8" height="8" rx="1" fill="#C9983A"/>
    </svg>
  ),
  chart: (
    <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  lightbulb: (
    <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M32 8c-11 0-20 9-20 20 0 7 3.5 13 9 17v7a4 4 0 004 4h14a4 4 0 004-4v-7c5.5-4 9-10 9-17 0-11-9-20-20-20z" stroke="#C9983A" strokeWidth="2" fill="#C9983A" fillOpacity="0.1"/>
      <path d="M26 56h12" stroke="#C9983A" strokeWidth="2" strokeLinecap="round"/>
      <path d="M32 8v8M44 20h8M12 20h8M40 12l4-4M24 12l-4-4" stroke="#C9983A" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  ),
};
