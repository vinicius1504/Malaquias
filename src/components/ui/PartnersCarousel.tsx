...
const partnerLogos: PartnerLogo[] = [
  { src: '/images/parceiros/logo (1).png', alt: 'Parceiro 1' },
  { src: '/images/parceiros/logo (1).jpg', alt: 'Parceiro 2' },
  { src: '/images/parceiros/logo (3).png', alt: 'Parceiro 3' },
  { src: '/images/parceiros/logo (4).png', alt: 'Parceiro 4' },
];
