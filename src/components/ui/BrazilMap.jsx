...
const BrazilMap = ({
  ...
  const handleClick = (stateId, stateName) => {
    if (onStateClick) {
      onStateClick(stateId, stateName);
    }
  };

  // Posições centrais de todos os estados
  const statePositions = {
    // Sudeste
    saopaulo: { x: 280, y: 327 },
    minasgerais: { x: 328, y: 286 },
    riodejaneiro: { x: 355, y: 330 },
    espiritosanto: { x: 382, y: 296 },
    // Sul
    parana: { x: 248, y: 356 },
    santacatarina: { x: 267, y: 388 },
    riograndedosul: { x: 231, y: 414 },
    // Centro-Oeste
    matogrosso: { x: 200, y: 218 },
    matogrossodosul: { x: 213, y: 307 },
    goias: { x: 267, y: 254 },
    distritofederal: { x: 300, y: 250 },
    // Nordeste
    bahia: { x: 360, y: 210 },
    sergipe: { x: 417, y: 194 },
    alagoas: { x: 436, y: 180 },
    pernambuco: { x: 401, y: 166 },
    paraiba: { x: 433, y: 145 },
    riograndedonorte: { x: 431, y: 119 },
    ceara: { x: 387, y: 129 },
    piaui: { x: 355, y: 158 },
    maranhao: { x: 318, y: 127 },
    // Norte
    tocantins: { x: 287, y: 188 },
    para: { x: 233, y: 123 },
    amapa: { x: 246, y: 53 },
    amazonas: { x: 98, y: 119 },
    roraima: { x: 136, y: 42 },
    acre: { x: 48, y: 185 },
    rondonia: { x: 118, y: 195 },
  };

  // Função para renderizar logo ou texto
  const renderStateContent = (stateId, textTransform, textContent) => {
    const pos = statePositions[stateId];
    if (!pos) {
      return <text transform={textTransform} fill="#FFFFFF">{textContent}</text>;
    }

    if (highlightedStates.includes(stateId)) {
      return <image className="active-logo" href={logoSrc} x={pos.x - 15} y={pos.y - 15} width="30" height="30" />;
    } else if (showAllLogos) {
      return <image href={grayLogoSrc} x={pos.x - 12} y={pos.y - 12} width="24" height="24" style={{ opacity: 0.5 }} />;
    } else {
      return <text transform={textTransform} fill="#FFFFFF">{textContent}</text>;
    }
  };
  ...
  return (
    <div>
      <style>{`
        #svg-map path { fill:#111B2C; stroke:#BD9657; stroke-width:1.0404 }
        #svg-map text { fill:#fff; font:12px Arial-BoldMT, sans-serif; cursor:pointer }
        #svg-map a { text-decoration:none }
        #svg-map a:hover { cursor:pointer; text-decoration:none }
        #svg-map a:hover path { fill:#5D6E8B !important }
        #svg-map .circle { fill:#111B2C; stroke:#BD9657 }
        #svg-map a:hover .circle { fill:#BD9657 !important; cursor:pointer }
      ...
      >
        <g>
          {/* Tocantins */}
          <a href="#tocantins" onClick={() => handleClick('tocantins', 'Tocantins')}>
            ...
            />
            {renderStateContent('tocantins', 'matrix(1 0 0 1 287.0137 188.3208)', 'TO')}
          </a>

          {/* Bahia */}
          <a href="#bahia" onClick={() => handleClick('bahia', 'Bahia')}>
            <title>Bahia</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('bahia', 'matrix(1 0 0 1 359.7324 210.1221)', 'BA')}
          </a>

          {/* Sergipe */}
          <a href="#sergipe" onClick={() => handleClick('sergipe', 'Sergipe')}>
            <title>Sergipe</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            <path
              className="circle"
              d="M417.324,182.854c6.214,0,11.266,5.035,11.266,11.262c0,6.208-5.052,11.261-11.266,11.261c-6.238,0-11.258-5.053-11.258-11.261C406.063,187.89,411.084,182.854,417.324,182.854z"
            />
             {renderStateContent('sergipe', 'matrix(1 0 0 1 417.324 182.854)', 'SE')}
          </a>

          {/* Pernambuco */}
          <a href="#pernambuco" onClick={() => handleClick('pernambuco', 'Pernambuco')}>
            ...
            />
            {renderStateContent('pernambuco', 'matrix(1 0 0 1 401.3984 165.8003)', 'PE')}
          </a>

          {/* Alagoas */}
          <a href="#alagoas" onClick={() => handleClick('alagoas', 'Alagoas')}>
            <title>Alagoas</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            <path
              className="circle"
              d="M436.423,168.763c6.236,0,11.258,5.054,11.258,11.278c0,6.207-5.02,11.259-11.258,11.259c-6.241,0-11.263-5.052-11.263-11.259C425.16,173.816,430.182,168.763,436.423,168.763z"
            />
            {renderStateContent('alagoas', 'matrix(1 0 0 1 429.7891 183.895)', 'AL')}
          </a>

          {/* Rio Grande do Norte */}
          <a href="#riograndedonorte" onClick={() => handleClick('riograndedonorte', 'Rio Grande do Norte')}>
            ...
            <path
              className="circle"
              d="M430.827,107.798c6.241,0,11.261,5.039,11.261,11.261c0,6.224-5.02,11.261-11.261,11.261c-6.209,0-11.26-5.037-11.26-11.261C419.567,112.837,424.618,107.798,430.827,107.798z"
            />
            {renderStateContent('riograndedonorte', 'matrix(1 0 0 1 422.541 123.9009)', 'RN')}
          </a>

          {/* Ceará */}
          <a href="#ceara" onClick={() => handleClick('ceara', 'Ceará')}>
            <title>Ceará</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('ceara', 'matrix(1 0 0 1 386.8379 129.0347)', 'CE')}
          </a>

          {/* Piauí */}
          <a href="#piaui" onClick={() => handleClick('piaui', 'Piauí')}>
            <title>Piauí</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('piaui', 'matrix(1 0 0 1 355.127 158.1045)', 'PI')}
          </a>

          {/* Maranhão */}
          <a href="#maranhao" onClick={() => handleClick('maranhao', 'Maranhão')}>
            ...
            />
            {renderStateContent('maranhao', 'matrix(1 0 0 1 318.2754 126.7036)', 'MA')}
          </a>

          {/* Amapá */}
          <a href="#amapa" onClick={() => handleClick('amapa', 'Amapá')}>
            <title>Amapá</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('amapa', 'matrix(1 0 0 1 245.9023 52.6099)', 'AP')}
          </a>

          {/* Pará */}
          <a href="#para" onClick={() => handleClick('para', 'Pará')}>
            <title>Pará</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('para', 'matrix(1 0 0 1 232.7725 122.5137)', 'PA')}
          </a>

          {/* Roraima */}
          <a href="#roraima" onClick={() => handleClick('roraima', 'Roraima')}>
            <title>Roraima</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
             {renderStateContent('roraima', 'matrix(1 0 0 1 136.2939 42.3862)', 'RR')}
          </a>

          {/* Amazonas */}
          <a href="#amazonas" onClick={() => handleClick('amazonas', 'Amazonas')}>
            ...
            />
            {renderStateContent('amazonas', 'matrix(1 0 0 1 98.1406 119.0591)', 'AM')}
          </a>

          {/* Acre */}
          <a href="#acre" onClick={() => handleClick('acre', 'Acre')}>
            <title>Acre</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('acre', 'matrix(1 0 0 1 47.7017 184.9355)', 'AC')}
          </a>

          {/* Rondônia */}
          <a href="#rondonia" onClick={() => handleClick('rondonia', 'Rondônia')}>
            ...
            />
            {renderStateContent('rondonia', 'matrix(1 0 0 1 118.1299 195.3193)', 'RO')}
          </a>

          {/* Mato Grosso */}
          <a href="#matogrosso" onClick={() => handleClick('matogrosso', 'Mato Grosso')}>
            ...
            />
            {renderStateContent('matogrosso', 'matrix(1 0 0 1 200.0244 218.4175)', 'MT')}
          </a>

          {/* Mato Grosso do Sul */}
          <a href="#matogrossodosul" onClick={() => handleClick('matogrossodosul', 'Mato Grosso do Sul')}>
            ...
            />
            {renderStateContent('matogrossodosul', 'matrix(1 0 0 1 213.2939 306.7236)', 'MS')}
          </a>

          {/* Goiás */}
          <a href="#goias" onClick={() => handleClick('goias', 'Goiás')}>
            <title>Goiás</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('goias', 'matrix(1 0 0 1 266.9111 254.2139)', 'GO')}
          </a>

          {/* Paraná */}
          <a href="#parana" onClick={() => handleClick('parana', 'Paraná')}>
            <title>Paraná</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            />
            {renderStateContent('parana', 'matrix(1 0 0 1 248.4453 356.1045)', 'PR')}
          </a>

          {/* Santa Catarina */}
          <a href="#santacatarina" onClick={() => handleClick('santacatarina', 'Santa Catarina')}>
            ...
            />
            {renderStateContent('santacatarina', 'matrix(1 0 0 1 266.9111 387.7646)', 'SC')}
          </a>

          {/* Rio Grande do Sul */}
          <a href="#riograndedosul" onClick={() => handleClick('riograndedosul', 'Rio Grande do Sul')}>
            ...
            />
            {renderStateContent('riograndedosul', 'matrix(1 0 0 1 231.0313 414.4658)', 'RS')}
          </a>

          {/* São Paulo */}
          <a href="#saopaulo" onClick={() => handleClick('saopaulo', 'São Paulo')}>
            ...
            />
            {renderStateContent('saopaulo', 'matrix(1 0 0 1 280.6816 327.3193)', 'SP')}
          </a>

          {/* Minas Gerais */}
          <a href="#minasgerais" onClick={() => handleClick('minasgerais', 'Minas Gerais')}>
            ...
            />
            {renderStateContent('minasgerais', 'matrix(1 0 0 1 328.4063 286.4561)', 'MG')}
          </a>

          {/* Rio de Janeiro */}
          <a href="#riodejaneiro" onClick={() => handleClick('riodejaneiro', 'Rio de Janeiro')}>
            ...
            <path
              className="circle"
              d="M355.094,318.613c6.209,0,11.263,5.021,11.263,11.259c0,6.208-5.056,11.264-11.263,11.264c-6.211,0-11.263-5.054-11.263-11.264C343.831,323.634,348.883,318.613,355.094,318.613z"
            />
            {renderStateContent('riodejaneiro', 'matrix(1 0 0 1 347.4648 334.6807)', 'RJ')}
          </a>

          {/* Espírito Santo */}
          <a href="#espiritosanto" onClick={() => handleClick('espiritosanto', 'Espírito Santo')}>
            ...
            <path
              className="circle"
              d="M381.917,284.723c6.21,0,11.261,5.055,11.261,11.262c0,6.212-5.051,11.261-11.261,11.261c-6.212,0-11.263-5.049-11.263-11.261C370.654,289.777,375.705,284.723,381.917,284.723z"
            />
            {renderStateContent('espiritosanto', 'matrix(1 0 0 1 373.3047 300.4971)', 'ES')}
          </a>

          {/* Distrito Federal */}
          <a href="#distritofederal" onClick={() => handleClick('distritofederal', 'Distrito Federal')}>
            ...
            <path
              className="circle"
              d="M300.735,238.34c6.212,0,11.26,5.035,11.26,11.258c0,6.21-5.048,11.263-11.26,11.263c-6.209,0-11.261-5.053-11.261-11.263C289.475,243.377,294.523,238.34,300.735,238.34z"
            />
            {renderStateContent('distritofederal', 'matrix(1 0 0 1 292.4141 254.2139)', 'DF')}
          </a>

          {/* Paraíba */}
          <a href="#paraiba" onClick={() => handleClick('paraiba', 'Paraíba')}>
            <title>Paraíba</title>
            <path
              stroke="#FFFFFF"
              strokeWidth="1.0404"
            ...
            <path
              className="circle"
              d="M433.797,133.597c6.237,0,11.26,5.051,11.26,11.261c0,6.226-5.022,11.262-11.26,11.262c-6.208,0-11.257-5.036-11.257-11.262C422.54,138.647,427.589,133.597,433.797,133.597z"
            />
            {renderStateContent('paraiba', 'matrix(1 0 0 1 425.2129 148.9893)', 'PB')}
          </a>
        </g>
      </svg>
    </div>
